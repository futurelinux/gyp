...
class VisualStudioVersion(object):
  ...
  def _SetupScriptInternal(self, target_arch):
    ...
    vcvarsall = normpath(join(self.path, 'VC', 'vcvarsall.bat'))
    vcvars32 = normpath(join(self.path, 'Common7', 'Tools', 'vsvars32.bat'))
    # 2. On newer VS it's in a different place and just takes arguments
    vcvars2017 = normpath(join(self.path,
